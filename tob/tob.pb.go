...
const (
	...
	PlayerEventType_PLAYER_DANMAGED PlayerEventType = 4
...
type ServerEvent struct {
	...
	Change *ServerChangeEvent `protobuf:"bytes,3,opt,name=change" json:"change,omitempty"`
}
...
func (m *ServerEvent) GetChange() *ServerChangeEvent {
	if m != nil {
		return m.Change
	}
	return nil
...
type PlayerEvent struct {
	...
	Danmaged   float32           `protobuf:"fixed32,6,opt,name=danmaged" json:"danmaged,omitempty"`
...
func (m *PlayerEvent) GetDanmaged() float32 {
	if m != nil {
		return m.Danmaged
	}
	return 0
...
func (*NodeInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func init() {
	...
	proto.RegisterType((*NodeInfo)(nil), "tob.NodeInfo")
...
type ToBClient interface {
	Subscribe(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (ToB_SubscribeClient, error)
...
func (c *toBClient) Subscribe(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (ToB_SubscribeClient, error) {
...
type ToBServer interface {
	Subscribe(*NodeInfo, ToB_SubscribeServer) error
...
var fileDescriptor0 = []byte{
	...
	,
}
