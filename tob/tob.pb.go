...
func (*Quad) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *Quad) GetA() float32 {
	if m != nil {
		return m.A
	}
	return 0
...
type PlayerMoveEvent struct {
	...
	Direction *Quad   `protobuf:"bytes,2,opt,name=direction" json:"direction,omitempty"`
}
...
func (m *PlayerMoveEvent) GetDirection() *Quad {
	if m != nil {
		return m.Direction
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Quad)(nil), "tob.Quad")
...
var fileDescriptor0 = []byte{
	...
	,
}
